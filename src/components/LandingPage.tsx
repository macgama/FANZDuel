...
import { Trophy, Swords, Users, Play, ChevronRight, Zap, Globe, Gamepad2, Layers, User, LineChart, Activity, AlertCircle, Coffee, ChevronDown, LogIn } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#111] text-white font-sans selection:bg-orange-500/30 overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-[#111]/80 backdrop-blur-xl border-b border-white/5 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-8">
            <div className="text-2xl font-black italic tracking-tighter text-orange-500">TBFO</div>
            <div className="hidden md:flex items-center gap-2 text-gray-400 font-bold text-xs cursor-not-allowed group">
              <Globe className="w-4 h-4" />
              <span className="uppercase tracking-widest group-hover:text-white transition-colors">FR</span>
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden min-h-screen flex flex-col items-center justify-center">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            Devenez le <br/>
            <span className="text-orange-500 drop-shadow-[0_0_30px_rgba(249,115,22,0.3)]">Meilleur Fan</span>
          </motion.h1>
          ...
          >
            Suivez les scores en direct, soutenez votre club et affrontez d'autres fans dans des duels stratégiques épiques.
          </motion.p>
        ...
        {/* Floating Assets */}
        <div className="absolute inset-0 pointer-events-none select-none overflow-hidden hidden xl:block">
           <motion.img 
             animate={{ y: [0, -20, 0], rotate: [0, 5, 0] }}
             transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
             src="https://thebestfan.online/img/public/fanz/imageFanz001Skin000.png" 
             className="absolute top-[15%] left-[5%] w-64 h-64 object-contain opacity-40 blur-[1px]"
           />
           <motion.img 
             animate={{ y: [0, 20, 0], rotate: [0, -5, 0] }}
             transition={{ duration: 5, repeat: Infinity, ease: "easeInOut" }}
             src="https://thebestfan.online/img/public/cards/card_boost.png" 
             className="absolute bottom-[20%] right-[5%] w-48 h-auto opacity-30 blur-[2px] -rotate-12"
           />
           <motion.img 
             animate={{ scale: [1, 1.1, 1], rotate: [12, 15, 12] }}
             transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
             src="https://thebestfan.online/img/public/emotes/emote_fire.png" 
             className="absolute top-[10%] right-[10%] w-32 h-32 opacity-20"
           />
           <motion.img 
             animate={{ x: [-10, 10, -10], rotate: [-10, -5, -10] }}
             transition={{ duration: 7, repeat: Infinity, ease: "easeInOut" }}
             src="https://thebestfan.online/img/public/fanz/imageFanz002Skin001.png" 
             className="absolute bottom-[10%] left-[15%] w-56 h-56 object-contain opacity-30 invert-[0.2]"
           />
        </div>
      </section>
      ...
      <section className="py-32 px-6 bg-[#0c0c0c] relative">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-black uppercase italic mb-2 tracking-tighter">L'expérience Ultime</h2>
            <p className="text-gray-500 font-bold uppercase tracking-[0.3em] text-xs md:text-sm">Vivez votre passion comme jamais</p>
          </div>
      ...
      <section className="py-32 px-6 border-y border-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-black uppercase italic mb-2 tracking-tighter">L'arène en chiffres</h2>
            <p className="text-gray-500 font-bold tracking-widest text-xs md:text-sm">Une communauté passionnée à travers le monde.</p>
          </div>

          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
            <StatItem icon={<Users className="w-6 h-6" />} value="..." label="Supporters" />
            <StatItem icon={<Globe className="w-6 h-6" />} value="..." label="En ligne" />
            <StatItem icon={<Activity className="w-6 h-6" />} value="0" label="Matchs Live" />
            <StatItem icon={<Swords className="w-6 h-6" />} value="..." label="Duels Actifs" />
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 max-w-4xl mx-auto text-center">
        <div className="bg-orange-950/20 border border-orange-500/20 rounded-3xl overflow-hidden mb-12 shadow-2xl">
          ...
          <div className="p-8 italic font-bold text-gray-400 leading-relaxed md:text-lg">
            "L'application est actuellement en phase de test. Des mises à jour et des ajustements techniques peuvent avoir lieu avant la version 1.0."
          </div>
        </div>

        <div className="space-y-4">
          <p className="uppercase font-black tracking-[0.3em] text-[10px] text-gray-500">Soutenir le développement</p>
          <a 
      ...
      <section className="py-32 px-6 bg-gradient-to-t from-orange-900/20 to-transparent border-t border-white/5">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-black uppercase italic mb-4 tracking-tighter leading-none">Prêt pour le <br className="md:hidden"/> coup d'envoi ?</h2>
          <p className="text-blue-400 font-bold mb-12 px-8 uppercase italic tracking-wider text-sm md:text-base">
            "Rejoignez des milliers de fans et montrez que votre ferveur n'a pas de limite."
          </p>
...
function LandingCard({ icon, title, description }: { icon: React.ReactNode, title: string, description: string }) {
  return (
    <div className="p-8 bg-[#151515] border border-white/5 rounded-3xl hover:border-orange-500/30 transition-all group">
      ...
      <h3 className="text-xl font-black uppercase italic mb-4 text-white group-hover:text-orange-500 transition-colors">{title}</h3>
...
function StatItem({ icon, value, label }: { icon: React.ReactNode, value: string, label: string }) {
  return (
    <div className="text-center group">
      ...
      <p className="text-gray-500 font-bold uppercase tracking-widest text-[9px] md:text-[10px]">{label}</p>
    </div>
  );
}
