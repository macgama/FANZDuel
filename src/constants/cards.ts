...
export const BASE_CARDS: Card[] = [
  ...
  },
  {
    ...
    rarity: 'common',
    energyCost: 25,
    description: 'Rend 40 points d\'énergie.',
    effects: [{ type: 'refill_energy', value: 40 }],
  ...
  },
  {
    ...
    rarity: 'common',
    energyCost: 35,
    description: 'Vole 30 points d\'énergie à l\'adversaire.',
    effects: [{ type: 'drain_energy', value: 30 }],
  ...
  },
  {
    ...
    rarity: 'epic',
    energyCost: 50,
    description: 'Double la régénération d\'énergie. Requis: Ferveur Niv. 2',
